        ...
        return (
            <div className='Popup'>
                <div className='Popup-content'>
                    <svg className='Popup-icon Popup-icon-close' onClick={this.hide}>
                        <use xlinkHref='/img/sprite.svg#icon-circle-with-cross'></use>
                    </svg>
                    ...
                    <div className='Popup-buttons'>
                        <button onClick={() => window.location.reload(false)} className='btn btn-secondary mr-sm'>Retry</button>
